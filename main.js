...
const sendEmail=(e)=>{
  ...
  if(contactName.value === '' ||contactEmail.value === '' || contactProjects.value===''){
    //add and remove color
       ...
       emailjs.sendForm('service_wxl8xnh','template_nzmk715','#contact-form','dQ9ugIQWSaxOh0X3v')
       .then(()=>{
        //Show message and add color
        contactMessage.classList.add('color-blue')
        contactMessage.textContent='Messege sent ✅'
        ...
        alert('OOPS! SOME PROBLEM OCCOURED...',error)
       })
